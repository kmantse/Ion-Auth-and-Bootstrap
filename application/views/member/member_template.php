...
<div class="wrapper" style="height: auto;">
    ...
    <section id="container">
        ...
        <header class="header white-bg">
            <?php include('include_member/navbar.php'); ?>
        </header>
        <!--header end-->
        <!--sidebar start-->
        <aside>
            <?php include('include_member/sidebar.php'); ?>
        </aside>
        <!--sidebar end-->
        <!--main content start-->
        ...
        <footer class="main-footer">
            <strong>Copyright © 2018 <a href="#">Ivie</a></strong> All rights
            reserved.
        </footer>
        <!--footer end-->
    </section>
    ...
    <!-- /.control-sidebar -->
    <?php include('include_member/control_sidebar.php'); ?>
