      ...
      <ul class="sidebar-menu">
        <li id="users" class="treeview">
            ...
            <ul class="treeview-menu">
              ...
              <li id="view_users" class=""><a href="<?php echo site_url('auth/user_list'); ?>"><i class="fa fa-circle-o"></i> View Users</a></li>
            </ul>
          </li>
      </ul>
        ...
        <ul class="sidebar-menu">
            <li id="users" class="treeview">
              ...
              <span class="pull-right-container">
                ...
                <ul class="treeview-menu">
                    <li id="add_user"><a href="<?php echo site_url('auth/create_group'); ?>"><i class="fa fa-circle-o"></i> Add Group</a></li>
                    <li id="view_users" class=""><a href="<?php echo site_url('auth/group_list'); ?>"><i class="fa fa-circle-o"></i> View Group</a></li>
                </ul>
            </li>
        </ul>
